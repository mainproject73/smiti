...
export const Speechquiz = () => {
    const navigate = useNavigate();
...

      {
        ...
        if(formValues.usertype==="Parent"){
          ...
          console.log(formValues);
          axios.post("http://localhost:5000/api/Speechquiz",formValues).then(()=>{

          }).catch(()=>{

          })
            navigate("/Behaviouralquiz", { replace: true });
        }
  ...
  return (<div className="quiz">
    <label className='heading1' ><h1><br/>For Speech Test</h1></label><br/><br/><br/>
    <form onSubmit={handleSubmit}><br/><br/>
    
    <table style={styleObj1}><tr>Is he/she able to communicate using speech/language?<br/><br/>
    ...
    <tr>whether your child is able to use gestures-such as pointing to an object-to give meaning to their speech?<br/><br/>
    ...
    <tr>Is he/she stammers while speaking?<br/><br/>
    ...
    <tr>whether he/she is able to speak clearly and with normal speed?<br/><br/>
    ...
    <tr>Is he/she repeats words someone has just said?<br/><br/>
    ...
    <tr>Whether your child speak in a high pitched voice?<br/><br/>
